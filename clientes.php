            ...
            <div id="content">
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    ...
                    if (!empty($_POST['id_cliente'])) {
                        ...
                        $query = "UPDATE CLIENTES SET NOME = ?, ENDERECO = ?, TELEFONE = ?, EMAIL = ? WHERE ID_CLIENTE = ?";
                        $stmt = $pdo->prepare($query);
                        $stmt->execute([$nome, $endereco, $telefone, $email, $id_cliente]);
                    } else {
                        $query = "INSERT INTO CLIENTES (NOME, ENDERECO, TELEFONE, EMAIL) VALUES (?, ?, ?, ?)";
                        $stmt = $pdo->prepare($query);
                                    ...
                                    <tbody>
                                        <?php foreach ($result as $row) : ?>
                                            <tr>
                                                ...
                                                <td><?= $row['EMAIL'] ?></td>
                                                <td>
                                                    <a href="clientes.php?edit=<?= $row['ID_CLIENTE'] ?>" class="btn btn-primary">Editar</a>
                                                    <a href="clientes.php?delete=<?= $row['ID_CLIENTE'] ?>" class="btn btn-danger">Excluir</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
